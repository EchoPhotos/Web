...
export const DownloadContext = React.createContext<IdDownloadWithAlbum>(
  {} as IdDownloadWithAlbum
);
...
export default function DownloadProvider({
  ...
  const [download, setDownload] = useState<IdDownloadWithAlbum | undefined>(
    undefined
  );
