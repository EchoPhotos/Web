...
export default function PhoneExplanationPopover() {
  return (
    <Popover>
      <PopoverButton className="text-xs font-semibold text-slate-400 focus:outline-hidden data-active:text-black data-hover:text-slate-500 data-focus:outline-1 data-focus:outline-white">
